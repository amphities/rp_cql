...
with open('cql_stuff/configs/fourrooms_train_config.pl', 'rb') as file:
...
with wandb.init(
        project="very-organized-organization-for-organizational-matters",
        group="rp",
    ...
    model.save("../models/dqn_four_rooms")
    train_env.close()
    eval_env.close()
